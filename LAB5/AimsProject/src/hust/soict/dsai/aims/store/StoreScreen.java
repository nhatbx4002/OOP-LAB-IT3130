...
public class StoreScreen extends JFrame {
    ...
    JPanel createCenter() {
        ...
        for (Media media : mediaInStore) {
            MediaStore cell = new MediaStore(media, cart); // Truyền cả cart
            center.add(cell);
        }
    ...
    private void showAddCDDialog() {
        ...
        if (result == JOptionPane.OK_OPTION) {
            try {
                ...
                CompactDisc newCD = new CompactDisc(id, title, category, cost, length, director);
    ...
    private void showAddDVDDialog() {
        ...
        if (result == JOptionPane.OK_OPTION) {
            try {
                ...
                DVD newDVD = new DVD(title, category, cost, length, director);
